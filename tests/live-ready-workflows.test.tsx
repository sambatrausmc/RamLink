...
describe("live-ready backend workflow helpers", () => {
  // Test that supported resource strings pass cleanly and unknown strings default to "Link"[cite: 1]
  ...
  // Test that officer reply generation formats IDs and default names properly[cite: 1]
