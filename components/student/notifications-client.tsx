  ...
  return (
    <div className="space-y-8">
      ...
      <section className="space-y-4">
        ...
        {loadState === "loading" ? (
          <p
            className="rounded-[12px] border border-brand-mist bg-white p-4 text-sm text-brand-muted"
            role="status"
          >
        ...
        {loadState === "error" ? (
          <p
            className="rounded-[12px] border border-red-200 bg-red-50 p-4 text-sm text-red-700"
            role="alert"
          >
            Notifications could not be refreshed. Showing the available saved
            data.
          </p>
        ) : null}
        {loadState !== "loading" && visibleNotifications.length ? (
          ...
          <EmptyState
            ...
            description={
              filter === "unread"
                ? "You are caught up."
                : "Notifications will appear here after RamLink actions are saved."
            }
          />
        ) : null}
      </section>
